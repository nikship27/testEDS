...
## Environments
- Preview: https://main--testEDS--nikship27.hlx.page/
- Live: https://main--testEDS--nikship27.hlx.live/
...
1. Open the `testEDS` directory in your favorite IDE and start coding :)
